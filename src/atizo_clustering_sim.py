...
import random
import csv
from kluster.util import *
from kluster.hebbian_clustering import *
import colorsys
...
def process_project(tfidf_file):
    ...
    n_clusters = 30
    n_visual_dimensions = 38469
    
    indices = range(tf_matrix.shape[0])
    random.shuffle(indices)
    rand_data = tf_matrix[indices, :]
    
    iterate(rand_data, n_clusters, n_visual_dimensions, indices)

if __name__ == "__main__":
    process_project("/home/hernani/uzh/FS2012/wahatttt/src/tf.txt")
